...
- FR-025: 手動で例文を追加できること。  
  Trace: request.md の「ゴール」「利用シナリオ」
- FR-026: 指定した単語の意味一覧を表示できること。  
  Trace: ユーザー指示（2026-02-05）
- FR-027: 指定した単語の例文一覧を表示できること。  
  Trace: ユーザー指示（2026-02-05）
- FR-028: 未登録単語を参照した場合は NotFound エラーとすること。  
  Trace: ユーザー指示（2026-02-05）
...
- ユーザー指示（2026-02-05） -> FR-026, FR-027, FR-028
